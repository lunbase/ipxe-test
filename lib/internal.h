...
struct pci_methods {
  ...
  int (*read_mem)(struct pci_dev *, int res, int pos, void *buf, int len);
  int (*write_mem)(struct pci_dev *, int res, int pos, void *buf, int len);
};
...
int dev_read_mem(struct pci_dev *d, int res, int pos, void *buf, int len);
int dev_write_mem(struct pci_dev *d, int res, int pos, void *buf, int len);
