...
u8 pci_read_res_byte(struct pci_dev *d, int res, int pos) PCI_ABI;
u16 pci_read_res_word(struct pci_dev *d, int res, int pos) PCI_ABI;
u32 pci_read_res_long(struct pci_dev *d, int res, int pos) PCI_ABI;
int pci_write_res_byte(struct pci_dev *d, int res, int pos, u8 value) PCI_ABI;
int pci_write_res_word(struct pci_dev *d, int res, int pos, u16 value) PCI_ABI;
int pci_write_res_long(struct pci_dev *d, int res, int pos, u32 value) PCI_ABI;
